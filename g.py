...
TOKEN = '8317814222:AAF-y17CXnX_6Kk8y4l5i55HWBkneRH7qhw' #Enter_Bot_Token_within_the_colons
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -100295212117   
...
def handle_message(message):
    ...
    if message.text == "Stop Attack 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/tr_banna1*", parse_mode='Markdown')
